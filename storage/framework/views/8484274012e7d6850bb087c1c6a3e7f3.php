        ...
        <div class="col-md-3 col-lg-2 sidebar">
            <div class="profile-section text-center py-4">
                <?php if(auth()->guard()->check()): ?>
                    <img src="<?php echo e(Auth::user()->avatar ?? 'https://via.placeholder.com/100'); ?>" 
            ...
            <div class="sidebar-menu">
                <a href="<?php echo e(url('/')); ?>" class="btn btn-sidebar <?php echo e(request()->is('/') ? 'active' : ''); ?>">
                    <i class="fas fa-home me-2"></i> Home
                </a>
                <a href="<?php echo e(url('/student/create')); ?>" class="btn btn-sidebar <?php echo e(request()->is('student/create') ? 'active' : ''); ?>">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CA-project\calender-events\resources\views/student/index.blade.php ENDPATH**/ ?>